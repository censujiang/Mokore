 ...
 * AUTHOR PROFILE
 */
if ( mokore_option('author_profile') == 'yes') {
?>
	<section class="author-profile">
		<div class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
			...
			<div class="meta">
				<span class="title"><?php esc_html_e('Author', 'mokore'); ?></span>	
				<h3 itemprop="name">
		...
		<hr>
		<p><i class="iconfont">&#xe761;</i><?php echo get_the_author_meta( 'description' ) ? get_the_author_meta( 'description' ) :mokore_option('admin_des', 'Carpe Diem and Do what I like'); ?></p>
	</section>
