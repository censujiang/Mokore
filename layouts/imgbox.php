...
<figure id="centerbg" class="centerbg" style="<?php echo $image_file.$bg_style ?>">
	...
	<div class="focusinfo">
		...
		<li><a href="<?php echo mokore_option('qzone', ''); ?>" target="_blank" class="social-qzone" title="qzone"><img src="<?php bloginfo('template_url'); ?>/images/sns/qzone.png"/></a></li>
		<?php } ?>
		...
		<li><a href="<?php echo mokore_option('bili', ''); ?>" target="_blank" class="social-bili" title="bilibili"><img src="<?php bloginfo('template_url'); ?>/images/sns/bilibili.png"/></a></li>
		<?php } ?>
		...
		<?php } ?>
		<?php if (mokore_option('wangyiyun')){ ?>
		<li><a href="<?php echo mokore_option('wangyiyun', ''); ?>" target="_blank" class="social-wangyiyun" title="CloudMusic"><img src="<?php bloginfo('template_url'); ?>/images/sns/wangyiyun.png"/></a></li>
		<?php } ?>
		<?php if (mokore_option('twitter')){ ?>
		<li><a href="<?php echo mokore_option('twitter', ''); ?>" target="_blank" class="social-wangyiyun" title="Twitter"><img src="<?php bloginfo('template_url'); ?>/images/sns/twitter.png"/></a></li>
		<?php } ?>	
		...
		<li><a href="<?php echo mokore_option('zhihu', ''); ?>" target="_blank" class="social-wangyiyun" title="知乎"><img src="<?php bloginfo('template_url'); ?>/images/sns/zhihu.png"/></a></li>
		<?php } ?>	
